...
namespace Print4e.Common
{
	...
	internal sealed class SuspensionManager
	{
		...
		/// </summary>
		public static Dictionary<string, object> SessionState { get { return _sessionState; } }
		...
		/// </summary>
		public static List<Type> KnownTypes { get { return _knownTypes; } }
		...
		{
			if (frame.GetValue(FrameSessionStateKeyProperty) != null) throw new InvalidOperationException("Frames can only be registered to one session state key");
		...
		public static Dictionary<String, Object> SessionStateForFrame(Frame frame)
		{
			...
			if (frameState == null)
			{
				...
				if (frameSessionKey != null)
				{
					...
					if (!_sessionState.ContainsKey(frameSessionKey)) _sessionState[frameSessionKey] = new Dictionary<String, Object>();
